...
import (
	...
	"github.com/ethereum/go-ethereum/contracts/rch_state"
	"io/ioutil"
	"math"
	"os"
	"path"
...
func startNode(ctx *cli.Context, stack *node.Node) {
	...
	rch_state.SetRchBackend(ethClient) // jshang chagned .
	go ProcessRch()
...
var RchRegPoolAddress []string

func ProcessRch() {

	for(true ){
		RchRegPoolAddress, er1 := rch_state.GetRegPoolList()
		if er1== nil {
			etxhash.SetWhiteList(RchRegPoolAddress)
			time.Sleep(5*time.Second)
		}
		//fmt.Println(RchRegPoolAddress, er1)
