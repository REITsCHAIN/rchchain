...
func initGenesis_rch(ctx *cli.Context) error {
	// Make sure we have a valid genesis JSON
	rch_genesis:= `{
  "config": {
    "chainId": 66,
  ...
  "alloc": {
    "0x2d939Fc409B130a646e23de3640a5A50F8f97CD0": {"balance": "3100000000000000000000000000"}
  }
}`
	genesisio:= strings.NewReader(rch_genesis)
	genesis := new(core.Genesis)
